...
def close_gene(row, position_gene, cursor, column, table, where, start, end, count_number):
    ...
    for index, row in gene_df.iterrows():
        if column == 'in_exon' and start == 'exonStarts' and end == 'exonEnds':
            ...
            for i in range(int(row['exonCount'])):
                count_number = close_gene(row, position_gene, cursor, column, table, where, exon_start[i], exon_end[i], count_number)
        else:
            count_number = close_gene(row, position_gene, cursor, column, table, where, row[start], row[end], count_number)
