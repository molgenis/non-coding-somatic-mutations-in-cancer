...
do
    echo $type_data
    PYTHON_SCRIPT='/groups/umcg-wijmenga/tmp01/projects/lude_vici_2021/rawdata/non-coding-somatic-mutations-in-cancer/Anne/scripts/analyse/'${TYPE_DATA[type_data]}'_multi.py'
    ...
    ANALYSE='/groups/umcg-wijmenga/tmp04/projects/lude_vici_2021/rawdata/cancer_data/analyse/'
