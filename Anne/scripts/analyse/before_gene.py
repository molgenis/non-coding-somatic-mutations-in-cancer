...
def run_all(type_bef_aft, path_db, path_save, select_chrom, i):
    filter_par = False
    ...
    tests_df = tests.all_test(df_b_nb, all_snps_b, all_snps_nb, 'NonCoding_Coding', f'{type_bef_aft}Gene', path_save, select_chrom, i)
...
def main():
    ...
    i = '0'
    type_bef_aft = 'before'
    run_all(type_bef_aft, path_db, path_save, select_chrom, i)
    type_bef_aft = 'after'
    run_all(type_bef_aft, path_db, path_save, select_chrom, i)
