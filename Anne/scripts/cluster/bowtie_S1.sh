...
#SBATCH --job-name=bw_S1
#SBATCH --output=bw_S1.out
#SBATCH --error=bw_S1.err
...
array=(  4094  4099  4104  ) # 4094  4099  4104  # 4109  4113  4114  4118  4119 #4123  4124  4129  # 4128  4133  4134 #  4139  4138  5041 # 5043  5042  5044 
# Array of sample numbers
array2=(  S1  S1  S1  ) # S1  S1  S1  # S2  S2  S2  S2  S2 # S3  S3  S3  # S4  S4  S4 # S5  S5  S5  # S6  S6  S6
array3=( S1 ) 
