...
#SBATCH --output=bw_S3.out
#SBATCH --error=bw_S3.err
...
array=(  4123  4124  4129  ) #4123  4124  4129  # 4128  4133  4134 #  4139  4138  5041 # 5043  5042  5044 
# Array of sample numbers
array2=(  S3  S3  S3  ) # S3  S3  S3  # S4  S4  S4 # S5  S5  S5  # S6  S6  S6
array3=( S1  S2  S3 ) 
