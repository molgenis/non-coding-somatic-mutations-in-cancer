...
NUMBER=5044
FILE_NUM=SS600${NUMBER}_chr22.sort
...
samtools sort -n ${PATH}${FILE_NUM}.bam -o ${PATH}${NUMBER}${FILE_NUM}_byName.sorted.bam

samtools fastq -@ 8 ${PATH}${NUMBER}${FILE_NUM}_byName.sorted.bam -1 ${PATH}${NUMBER}${FILE_NUM}_name_R1.fastq -2 ${PATH}${NUMBER}${FILE_NUM}_name_R2.fastq -0 /dev/null -s /dev/null -n
...
bwa mem ${GENOOM} ${PATH}${NUMBER}${FILE_NUM}_name_R1.fastq ${PATH}${NUMBER}${FILE_NUM}_name_R2.fastq > ${PATH}${NUMBER}/bwa_mem/mem_${FILE_NUM}.sam
align_test ${PATH}${NUMBER}/bwa_mem/mem_${FILE_NUM}

bwa aln ${GENOOM} ${PATH}${NUMBER}${FILE_NUM}_name_R1.fastq > ${PATH}${NUMBER}${FILE_NUM}_name_R1.sai && bwa aln ${GENOOM} ${PATH}${NUMBER}${FILE_NUM}_name_R2.fastq > ${PATH}${NUMBER}${FILE_NUM}_name_R2.sai && bwa sampe ${GENOOM} ${PATH}${NUMBER}${FILE_NUM}_name_R1.sai ${PATH}${NUMBER}${FILE_NUM}_name_R2.sai ${PATH}${NUMBER}${FILE_NUM}_name_R1.fastq ${PATH}${NUMBER}${FILE_NUM}_name_R2.fastq > ${PATH}${NUMBER}/bwa_aln/aln_${FILE_NUM}.sam
align_test ${PATH}${NUMBER}/bwa_aln/aln_${FILE_NUM}

#BOWTIE2
bowtie2-build ${GENOOM} ${PATH}${NUMBER}/bowtie/GENOOM
bowtie2 -p 4 -x ${PATH}${NUMBER}/bowtie/GENOOM -1 ${PATH}${NUMBER}${FILE_NUM}_name_R1.fastq -2 ${PATH}${NUMBER}${FILE_NUM}_name_R2.fastq -S ${PATH}${NUMBER}/bowtie/bowtie2_${FILE_NUM}.sam
