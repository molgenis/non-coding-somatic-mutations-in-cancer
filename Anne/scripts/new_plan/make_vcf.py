...
# Get vcf_dict (key: SNP_ID, value: dict --> (key: vcf columns or donor_id, value: information out of columns or format structure of donor))
vcf_dict = overview.get_vcf_dict()
# Get all_donors (key: donor_id, value: list of format structure <-- but this is for when the donors hasn't that snp)
