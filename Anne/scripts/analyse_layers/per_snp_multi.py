...
def make_snp_df(df, type_df, type_c, path_file, select_chrom):
    ...
    :return:    num_donor: Number of donors
                sort_snp_count_df: Data frame with 1 column with SNP IDs and the other column with
                                   how often this snp occurs
    """
...
def run_snp_tests(df_breast, df_nonbreast, type_df, type_analyse, path_file, select_chrom):
    ...
    sort_snp_count_both_0.to_csv(f"{path_file}{type_analyse}_{type_df}_both_0_{select_chrom}.tsv", sep='\t',
