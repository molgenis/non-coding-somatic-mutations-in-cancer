...
#SBATCH --job-name=/groups/umcg-wijmenga/tmp01/projects/lude_vici_2021/rawdata/non-coding-somatic-mutations-in-cancer/Anne/scripts/pipeline_variant_calling/jobs/S1_bwa_mem
#SBATCH --output=/groups/umcg-wijmenga/tmp01/projects/lude_vici_2021/rawdata/non-coding-somatic-mutations-in-cancer/Anne/scripts/pipeline_variant_calling/jobs/S1_bwa_mem.out
#SBATCH --error=/groups/umcg-wijmenga/tmp01/projects/lude_vici_2021/rawdata/non-coding-somatic-mutations-in-cancer/Anne/scripts/pipeline_variant_calling/jobs/S1_bwa_mem.err
